...
public class PhotoController {
	...
	@PostMapping()
	public @ResponseBody
	Integer addNewPhoto(@RequestBody Photo photo) {
	...
	public @ResponseBody
	void addNewPhotos(@RequestBody List<Photo> photolist) {
	...
	@GetMapping(path= "{id}")
	public @ResponseBody
	Optional<Photo> getPhotoByID(@PathVariable Integer id, @RequestBody Photo photo) {
	...
	@PutMapping(path= "{id}")
	public @ResponseBody
	void updatePhotoByID(@PathVariable Integer id, @RequestBody Photo photo) {
		photo.setID(id);
	...
	@PutMapping(path = "{id}")
	public @ResponseBody
	void deletePhotoByID(@PathVariable Integer id, @RequestBody Photo photo) {
		photo.setID(id);
